...
describe('transformPath option', () => {
  it('should transform target path for file', (done) => {
    runEmit({
  ...
  it('should transform target path of every file in directory', (done) => {
    runEmit({
      expectedAssetKeys: [
  ...
  it('should transform target path of every file in glob', (done) => {
    runEmit({
      expectedAssetKeys: [
